...
從 SALARY 的「首年獎金化」與「1 單位」陷阱、到 WORKTIME 的「特休協商」與 WFH 數位集中營、到 MANIPULATION 的「心理彈性引導」與主管 PUA、到 PROMISES 的「階梯式精算」、到 LOOPHOLE 的「合法套牢」、模糊定義術、派遣免洗化與試用期黃金 6 個月、到 RETENTION 的「無傷退場」與反敲詐、到 POLITICS 的「大智若愚」、工會分化與「杯酒釋兵權」、到 CRISIS 的媒體危機處理——
